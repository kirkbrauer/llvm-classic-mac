//===-- macos_classic_cxx.c - C++ Runtime Support for M68k -----*- C -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// Minimal C++ runtime support for M68k Classic Mac OS applications.
//
...
//===----------------------------------------------------------------------===//
// Exit Function - Uses M68k Trap for ExitToShell
//===----------------------------------------------------------------------===//

// ExitToShell trap - A9F4
// We use inline assembly to invoke the trap directly
static void ExitToShell(void) __attribute__((noreturn));
